...
const DesignDepartment: React.FC<AllEmployeesProps> = ({ onMount }) => {
  React.useEffect(() => {
    if (onMount) onMount();
  }, [onMount]);
  ...
  return (
    <div className="w-full flex flex-col bg-white">
      <div className="mb-4">
        <Topbar 
          title={
            <div className="font-bold text-[16px] leading-6 text-[#16151C]">
              Design Department
            </div>
          } 
            ...
            <Button 
              label={
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-base leading-6 text-white text-[16px]">Add New Employee</span>
                </div>
              }
